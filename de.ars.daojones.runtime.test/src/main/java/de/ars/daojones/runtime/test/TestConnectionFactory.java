...
public class TestConnectionFactory implements ConnectionFactory {
  ...
  @Override
  public final <T> Connection<T> createConnection( final ConnectionContext<T> context ) throws ConnectionBuildException {
    try {
      ...
      synchronized ( connectionPerBean ) {
        ...
        if ( connectionPerBean.containsKey( id ) ) {
          ...
          final Model model = readContent( context.getConnectionModel() );
