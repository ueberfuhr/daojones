...
import static de.ars.daojones.connections.model.IConnectionConfigurationConstants.SCHEMA;
...
abstract class JAXBUtilities {
	...
	public static JAXBContext getContext() throws JAXBException {
		final JAXBContext result = JAXBContext.newInstance(
			IConnectionConfiguration.class.getPackage().getName()
		);
		return result;
	}
	...
	public static Schema getSchema() throws SAXException {
		final SchemaFactory factory = SchemaFactory.newInstance(XMLConstants.W3C_XML_SCHEMA_NS_URI);
       	final Schema schema = factory.newSchema(new StreamSource(JAXBUtilities.class.getResourceAsStream(SCHEMA)));
       	return schema;
	}
