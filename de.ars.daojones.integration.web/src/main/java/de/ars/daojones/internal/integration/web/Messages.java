...
public final class Messages {
   ...
   */
  public static final String LOGGER_NAMESPACE = "de.ars.daojones.integration.web.";
  /**
   * The namespace for the bundle names.
   */
  public static final String BUNDLE_NAMESPACE = "de.ars.daojones.internal.integration.web.";
