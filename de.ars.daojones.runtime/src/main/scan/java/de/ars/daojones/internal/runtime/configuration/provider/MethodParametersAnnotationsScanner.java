...
class MethodParametersAnnotationsScanner extends AbstractScanner {
   ...
   */
  public static Parameter getParameterFromDescriptor( final String descriptor,
          final ClassLoader dependenciesClassLoader ) {
    ...
    for ( int i = 2; i < parts.length - 1; i++ ) {
      parameterTypes[i - 2] = ReflectionUtils.forName( parts[i], dependenciesClassLoader );
    }
    try {
