...
public class GeneratorUtility {
	...
	/**
	 * This method iterates over a collection of elements, puts each element
	 * into the context using a specific variable name, and executes the
	 * expression. The results are concatenated using separator, begin and end.
	 * In the expression, u can use a variable named "counter" to get the
	 * current zero-based-index within the loop.
	 * 
	 * @param col
	 ...
	 * @param expr
	 *            the expression to evaluate (note that you have to escape
	 *            control sequences in the template)
	 * @param begin
	...
	public String join(Collection<Object> col, String var, String expr,
        ...
        this.context.put("counter", idx+1);
				...
				try {
					Velocity.evaluate(context, out, this.template.getName(),
							expr);
				} finally {
	...
	/**
	 * This method iterates over an array of elements, puts each element into
